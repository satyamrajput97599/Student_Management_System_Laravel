...
<div class="col-md-4 ">
<h5 class="bg3 p-2">Course Form</h5>
<form method="get">
...
<div class="col-md-6">
<h5 class="bg3 p-2">Course list</h5>
...
<tr>
    ...
    <td><a href="/delete?delid={{$row['id']}} " class="btn btn-primary">Delete</a>
    <a href="/edit?editid={{$row['id']}}" class="btn btn-warning">Edit</a>
</td>
